...
echo "=== ИСПРАВЛЕНИЕ ФОРМАТА ЗАПРОСА TELEGRAM ==="

echo "1. Остановка API:"
docker-compose stop api

echo -e "\n2. Создание правильного auth_handler.go:"
docker-compose exec api sh -c 'cat > /app/internal/handlers/auth_handler.go << "EOF"
package handlers
